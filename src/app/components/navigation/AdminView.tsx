...
const validateCoordinates = (lat: number, lng: number, campus: string): boolean => {
  const campusBounds = CAMPUS_BOUNDS[campus];
  if (!campusBounds) return false;

  const minLat = Math.max(campusBounds.se[0], campusBounds.sw[0]);
  const maxLat = Math.min(campusBounds.nw[0], campusBounds.ne[0]);
  const minLng = Math.min(campusBounds.nw[1], campusBounds.sw[1]);
  const maxLng = Math.max(campusBounds.ne[1], campusBounds.se[1]);
...
export default function AdminView({ onGoHome }: AdminViewProps) {
  ...
  const handleFloorSliderInteraction = (clientY: number) => {
    ...
    // Floor 1 at bottom (percentage = 1), Floor 3 at top (percentage = 0)
  ...
  return (
    <div className="size-full relative">
      ...
      {!showPOIPanel && !showManagePanel && !selectedPOI && (
        <div className="absolute bottom-8 right-8 z-[1000] flex flex-col gap-4">
          <button
            ...
            className="bg-[#C8102E] text-white w-16 h-16 rounded-full shadow-lg hover:bg-[#9a0c24] transition-colors flex items-center justify-center"
            title="Panel de POI"
          >
      ...
      {showManagePanel && (
        <div className="fixed inset-x-4 top-1/2 -translate-y-1/2 z-[1001] mx-auto max-w-md">
          <div className="bg-white rounded-lg shadow-xl border border-slate-200 shadow-[0_4px_4px_rgba(0,0,0,0.28)] p-6">
            {manageView === 'main' && (
              <>
                <div className="flex justify-between items-center mb-6">
                ...
                <div className="flex flex-col gap-4">
                  <button
                    ...
                    className="px-6 py-4 bg-slate-50 rounded-lg hover:bg-slate-100 text-[rgb(0,50,130)] border-2 border-gray-300"
                  >
                    Crear POI
                  </button>
                  <button
                  ...
                  <select
                    ...
                    className={`w-full px-4 py-3 border-2 rounded-lg focus:outline-none focus:ring-2 ${
                      showErrors && !selectedPOIForEdit
                        ...
                        : 'border-[rgb(0,50,130)] focus:ring-[#C8102E]'
                    }`}
                  >
              ...
              <>
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <button
                    ...
                    className="w-full px-6 py-3 bg-[#C8102E] text-white rounded-lg hover:bg-[#9a0c24] transition-colors"
                  >
                    Confirmar
                  </button>
                </div>
              ...
              <>
                ...
                <div className="flex flex-col gap-4 max-h-[60vh] overflow-y-auto">
                  ...
                  <button
                    ...
                    className="w-full px-6 py-3 bg-slate-50 border-2 border-gray-300 text-[rgb(0,50,130)] rounded-lg hover:bg-slate-100 transition-colors"
                  >
                    Enlace externo
                  </button>
      ...
      {showExternalLinkPanel && (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-[1002] flex items-center justify-center">
          <div className="bg-white rounded-lg shadow-xl border border-slate-200 shadow-[0_4px_4px_rgba(0,0,0,0.28)] p-6 w-[90%] max-w-md">
            <div className="flex justify-between items-center mb-6">
        ...
        <>
          ...
          <div className="absolute bottom-4 left-4 right-4 z-[1000] bg-white rounded-lg shadow-xl border border-slate-200 shadow-[0_4px_4px_rgba(0,0,0,0.28)] max-w-md mx-auto p-4">
            ...
            {detailError ? (
              ...
              <div>
                <h4 className="text-sm text-slate-600 mb-2">Enlaces externos:</h4>
