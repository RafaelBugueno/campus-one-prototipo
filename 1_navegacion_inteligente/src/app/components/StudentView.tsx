...
import { Search, List, Filter, X, MapPin, Lightbulb, Calendar } from 'lucide-react';
            ...
            <div className="fixed inset-x-4 top-16 bottom-0 z-[1001] flex items-center justify-center pointer-events-none">
              <div className="bg-white rounded-lg shadow-xl border-2 border-slate-200 p-6 w-full max-w-md pointer-events-auto">
                <div className="flex justify-between items-center mb-6">
                  ...
                  <button onClick={() => { setShowSuggestPanel(false); setShowErrors(false); }}>
                    <X className="w-5 h-5 text-gray-500" />
                  </button>
                </div>
                ...
                <div className="flex flex-col gap-4">
                  <input
                    ...
                    className={`w-full px-4 py-3 border-2 rounded-lg focus:outline-none focus:ring-2 ${
                      showErrors && !suggestName ? 'border-red-500 focus:ring-red-500' : 'border-[rgb(0,50,130)] focus:ring-blue-500'
                    }`}
                  />
                  <select
                    ...
                    className={`w-full px-4 py-3 border-2 rounded-lg focus:outline-none focus:ring-2 ${
                      showErrors && !suggestCategory ? 'border-red-500 focus:ring-red-500' : 'border-[rgb(0,50,130)] focus:ring-blue-500'
                    }`}
                  >
                  ...
                  <select
                    ...
                    className={`w-full px-4 py-3 border-2 rounded-lg focus:outline-none focus:ring-2 ${
                      showErrors && !suggestCampus ? 'border-red-500 focus:ring-red-500' : 'border-[rgb(0,50,130)] focus:ring-blue-500'
                    }`}
                  >
                  ...
                  <select
                    ...
                    className={`w-full px-4 py-3 border-2 rounded-lg focus:outline-none focus:ring-2 ${
                      showErrors && !suggestFloor ? 'border-red-500 focus:ring-red-500' : 'border-[rgb(0,50,130)] focus:ring-blue-500'
                    }`}
                  >
