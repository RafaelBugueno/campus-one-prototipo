...
import { KpiCard } from "@/components/rating/KpiCard";
        ...
        <Card className="lg:col-span-2 shadow-card border-border/60">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            ...
            <Button variant="ghost" size="sm" asChild className="text-xs">
              <Link to="/analytics">Ver analytics <ArrowRight className="ml-1 h-3 w-3" /></Link>
            </Button>
          </CardHeader>
          <CardContent>
            <div className="h-64">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <Card className="lg:col-span-2 shadow-card border-border/60">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            ...
            <Button variant="ghost" size="sm" asChild className="text-xs">
              <Link to="/rankings">Ver rankings <ArrowRight className="ml-1 h-3 w-3" /></Link>
            </Button>
          </CardHeader>
